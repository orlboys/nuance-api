...
NUM_EPOCHS         = 10        # 8 epochs for small dataset; can increase for larger datasets
...
NICKNAME           = f"{NUM_EPOCHS}_epochs_{LEARNING+RATE}_lr_testmodel"  # Name of the model for saving/loading checkpoints
